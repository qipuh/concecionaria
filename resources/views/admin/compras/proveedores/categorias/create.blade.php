...
@section('title', 'Nueva Categoría de Proveedor')

@section('header', 'Nueva Categoría de Proveedor')
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4">
                    <div class="mb-3 mb-sm-0">
                        ...
                        <p class="text-muted small mb-0">Registra una nueva categoría de proveedor desde aquí</p>
                    </div>
                </div>

                <!-- Formulario -->
                <form method="POST" action="{{ route('admin.compras.proveedores.categorias.store') }}" class="needs-validation" novalidate>
                    @csrf
                    <div class="mb-4">
                        <label for="nombre_categoria_proveedor" class="form-label small text-muted mb-1">Nombre de la Categoría</label>
                        <input type="text" 
                               ...
                               value="{{ old('nombre_categoria_proveedor') }}" 
                               required>
