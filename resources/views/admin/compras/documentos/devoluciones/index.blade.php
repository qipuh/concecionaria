    ...
    <div class="container-fluid position-relative z-1">
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center">
            ...
            <div class="d-flex flex-wrap gap-2">
                <a href="{{ route('admin.devoluciones.create') }}" class="btn bg-white text-dark rounded-pill px-4 py-2 fw-bold shadow-sm transition hover:scale-105 border-0">
            ...
            <div class="alert alert-info border-0 shadow-sm rounded-4 mb-4 bg-info bg-opacity-10 text-info">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <span class="small">La funcionalidad de vales de devolución está siendo implementada.</span>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="py-3 px-4 border-0">Motivo</th>
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-5">
                                <div class="bg-light d-inline-flex p-4 rounded-circle mb-3">
                                    <i class="fas fa-undo text-muted fa-3x"></i>
                                </div>
