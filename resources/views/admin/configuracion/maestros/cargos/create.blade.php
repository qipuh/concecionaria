            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4">
                    <div class="mb-3 mb-sm-0">
                        ...
                        <p class="text-muted small mb-0">Registra un nuevo cargo desde aquí</p>
                    </div>
                </div>

                <!-- Formulario -->
                <form method="POST" action="{{ route('admin.configuracion.maestros.cargos.store') }}" class="needs-validation" novalidate>
                    @csrf
                    <div class="mb-4">
