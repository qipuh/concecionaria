...
@section('header', 'Nuevo Centro de Costo')
    ...
    <div class="col-12">
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-4">
                <h2 class="h4 fw-bold mb-4">Crear Nuevo Centro de Costo</h2>
                <form method="POST" action="{{ route('admin.configuracion.centros_costos.store') }}" class="needs-validation" novalidate>
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
