        ...
        <div class="col-md-12">
            <div class="card shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5>Editar Devolución a Proveedor</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.inventario.devoluciones.update', $devolucion->id) }}" method="POST" id="devolucionForm">
                            ...
                            <table class="table table-hover" id="tablaItems">
                                ...
                                <tbody>
                                    ...
                                    <tr id="row-{{ $index }}">
                                        ...
                                        <td>{{ $detalle->item->unidad->nombre ?? 'N/A' }}</td>
                                        <td>
                                            <input type="number" name="items[{{ $index }}][cantidad]" value="{{ $detalle->cantidad }}" min="0.01" step="0.01" class="form-control form-control-sm" required>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-danger eliminar-item" data-row="{{ $index }}">
                        ...
                        <div class="mt-4 d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary" id="submitBtn">Actualizar Devolución</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.eliminar-item', function() {
            ...
            if ($('#tablaItems tbody tr').length === 0) {
                $('#tablaItems tbody').append('<tr id="noItemsRow"><td colspan="6" class="text-center">No hay productos agregados</td></tr>');
            }
        });
