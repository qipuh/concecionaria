    ...
    <div class="container-fluid position-relative z-1">
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center">
            <div class="mb-3 mb-lg-0">
                ...
                <h2 class="fw-bold mb-1 tracking-tight text-white display-6 text-shadow-sm">Nueva Devolución a Proveedor</h2>
                <p class="text-white-50 mb-0">Registra una nueva devolución de productos</p>
            </div>
