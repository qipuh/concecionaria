    ...
    <div class="container-fluid position-relative z-1">
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center">
            <div class="mb-3 mb-lg-0">
                ...
                <h2 class="fw-bold mb-1 tracking-tight text-white display-6 text-shadow-sm">Editar Movimiento</h2>
                <p class="text-white-50 mb-0">Actualiza los datos del movimiento</p>
            </div>
...
<div class="container-fluid px-3 px-lg-4 position-relative" style="top: -3.5rem; z-index: 10;">
    <div class="card dashboard-card border-0 shadow-sm mb-4">
        <div class="card-header bg-white border-0 pt-4 pb-0 px-4">
            <h6 class="fw-bold mb-0"><i class="fas fa-edit me-2 text-primary"></i> Datos del Movimiento</h6>
        </div>
