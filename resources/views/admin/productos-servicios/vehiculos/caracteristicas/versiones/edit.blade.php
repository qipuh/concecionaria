                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4">
                    <div class="mb-3 mb-sm-0">
                        <h2 class="h4 fw-bold mb-1" :class="darkMode ? 'text-light' : 'text-dark'">
                            Editar Versión: {{ $version->nombre }}
                        </h2>
                        <p class="text-muted small mb-0">Actualiza los datos de la versión desde aquí</p>
                    </div>
                </div>

                <form method="POST" action="{{ route('admin.productos-servicios.vehiculos.caracteristicas.versiones.update', $version) }}" class="needs-validation" novalidate>
                    @csrf
                    @method('PUT')
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select name="marca_id" 
                                ...
                                @foreach ($marcas as $marca)
                                    <option value="{{ $marca->id }}" {{ old('marca_id', $version->marca_id) == $marca->id ? 'selected' : '' }}>
                                        {{ $marca->nombre }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="modelo_id" 
                                ...
                                @foreach ($modelos as $modelo)
                                    <option value="{{ $modelo->id }}" {{ old('modelo_id', $version->modelo_id) == $modelo->id ? 'selected' : '' }}>
                                        {{ $modelo->nombre }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('nombre', $version->nombre) }}" 
                                   required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('carroceria', $version->carroceria) }}" 
                                   required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" 
                                   ...
                                   :class="darkMode ? 'bg-dark-subtle text-light border-secondary' : ''" 
                                   placeholder="Ej: 2.0L" 
                                   value="{{ old('cilindrada', $version->cilindrada) }}" 
                                   required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('transmision', $version->transmision) }}" 
                                   required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('traccion', $version->traccion) }}" 
                                   required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="combustible_id" 
                                ...
                                @foreach ($combustibles as $combustible)
                                    <option value="{{ $combustible->id }}" {{ old('combustible_id', $version->combustible_id) == $combustible->id ? 'selected' : '' }}>
                                        {{ $combustible->nombre }}
                                    </option>
                                @endforeach
                            </select>
