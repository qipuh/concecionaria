...
@section('title', 'Nuevo Año de Modelo')

@section('header', 'Nuevo Año de Modelo')
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4">
                    <div class="mb-3 mb-sm-0">
                        <h2 class="h4 fw-bold mb-1" :class="darkMode ? 'text-light' : 'text-dark'">
                            Crear Nuevo Año de Modelo
                        </h2>
                        <p class="text-muted small mb-0">Registra un nuevo año de modelo desde aquí</p>
                    </div>
                </div>

                <form method="POST" action="{{ route('admin.productos-servicios.vehiculos.caracteristicas.anios-modelo.store') }}" class="needs-validation" novalidate>
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="moneda" 
                                ...
                                <option value="SOL" {{ old('moneda') == 'SOL' ? 'selected' : '' }}>SOL</option>
