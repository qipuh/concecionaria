                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4">
                    <div class="mb-3 mb-sm-0">
                        <h2 class="h4 fw-bold mb-1" :class="darkMode ? 'text-light' : 'text-dark'">
                            Editar Modelo: {{ $modelo->nombre }}
                        </h2>
                        <p class="text-muted small mb-0">Actualiza los datos del modelo desde aquí</p>
                    </div>
                </div>

                <form method="POST" action="{{ route('admin.productos-servicios.vehiculos.caracteristicas.modelos.update', $modelo) }}" class="needs-validation" novalidate enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('duracion_garantia', $modelo->duracion_garantia) }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" 
                                       ...
                                       value="{{ old('cantidad_anos', $modelo->cantidad_anos) }}" 
                                       min="1" 
                                       required>
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($modelo->ficha_tecnica)
                                <small class="form-text text-muted">Archivo actual: <a href="{{ asset('storage/' . $modelo->ficha_tecnica) }}" target="_blank">Ver Ficha</a></small>
                            @endif
