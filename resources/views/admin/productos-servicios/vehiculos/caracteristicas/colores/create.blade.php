            ...
            <div class="card-body p-4">
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4">
                    <div class="mb-3 mb-sm-0">
                        ...
                        <p class="text-muted small mb-0">Registra un nuevo color desde aquí</p>
                    </div>
                </div>

                <form method="POST" action="{{ route('admin.productos-servicios.vehiculos.caracteristicas.colores.store') }}" class="needs-validation" novalidate>
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
...
@push('scripts')
    <script>
        (function () {
            ...
            // Sincronización entre el input de color y el campo hexadecimal
            const colorPicker = document.getElementById('colorPicker');
            const hexInput = document.getElementById('hexadecimal');

            // Actualizar el campo hexadecimal cuando se selecciona un color
            colorPicker.addEventListener('input', function () {
                hexInput.value = this.value;
            });

            // Actualizar el input de color cuando se edita el campo hexadecimal
            hexInput.addEventListener('input', function () {
                // Validar que el valor sea un hexadecimal válido (ejemplo: #FF0000)
