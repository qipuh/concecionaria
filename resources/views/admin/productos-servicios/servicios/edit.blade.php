...
@section('header', 'Editar Servicio Tercerizado')
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4">
                    <div class="mb-3 mb-sm-0">
                        <h2 class="h4 fw-bold mb-1" :class="darkMode ? 'text-light' : 'text-dark'">
                            Editar Servicio Tercerizado: {{ $servicioTercerizado->nombre }}
                        </h2>
                        <p class="text-muted small mb-0">Actualiza los datos del servicio desde aquí</p>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <select name="moneda" 
                                        ...
                                        required>
                                    <option value="SOL" {{ old('moneda', $servicioTercerizado->moneda) == 'SOL' ? 'selected' : '' }}>Soles</option>
                                    <option value="USD" {{ old('moneda', $servicioTercerizado->moneda) == 'USD' ? 'selected' : '' }}>Dólares</option>
                                </select>
