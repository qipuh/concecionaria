...
@section('title', 'Nueva Categoría de Servicios')
    ...
    <div class="container-fluid position-relative z-1">
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center">
            <div class="mb-3 mb-lg-0">
                ...
                <p class="text-white-50 mb-0">Organiza tus servicios tercerizados mediante nuevas categorías</p>
            </div>
...
<div class="container-fluid px-3 px-lg-4 position-relative" style="top: -3.5rem; z-index: 10;">
    <div class="card dashboard-card border-0 shadow-sm mb-4">
        <div class="card-body p-4">
            <!-- Formulario -->
            <form method="POST" action="{{ route('admin.productos-servicios.servicios.categorias.store') }}" class="needs-validation" novalidate>
                @csrf
                <div class="row g-4">
                    <div class="col-md-12">
                        ...
                        <input type="text" 
                               ...
                               placeholder="Ej. Soporte Técnico, Consultoría, etc." 
                               value="{{ old('nombre') }}" 
                               required>
