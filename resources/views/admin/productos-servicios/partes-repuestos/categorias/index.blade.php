...
@section('title', 'Categorías de Partes')

@section('header', 'Gestión de Categorías de Partes')
            ...
            <div class="card-body p-4">
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4">
                    <div class="mb-3 mb-sm-0">
                        ...
                        <p class="text-muted small mb-0">Gestiona las categorías de partes desde aquí</p>
                    </div>
                    <div>
                        <a href="{{ route('admin.almacenes.partes.categorias.create') }}" class="btn btn-primary d-flex align-items-center">
                    ...
                    <table class="table table-hover align-middle" :class="darkMode ? 'table-dark' : ''">
                        <thead class="table-light" :class="darkMode ? 'table-dark' : ''">
                            <tr>
                                ...
                                <th scope="col" class="text-uppercase small">Descuento (%)</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('admin.almacenes.partes.categorias.edit', $categoria) }}" class="btn btn-outline-warning" title="Editar">
                                            ...
                                            <form action="{{ route('admin.almacenes.partes.categorias.destroy', $categoria) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="5" class="py-5 text-center">
                                        <div class="d-flex flex-column align-items-center justify-content-center">
                                            ...
                                            <p class="text-muted mb-2">No hay categorías de partes registradas</p>
                                            <a href="{{ route('admin.almacenes.partes.categorias.create') }}" class="btn btn-sm btn-link text-decoration-none">
